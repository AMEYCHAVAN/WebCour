 ...
 */
@WebServlet(name = "schcust", urlPatterns = {"/schcust"})
public class schcust extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           String nos=request.getParameter("cid");
...
cousys.concourier.createconnection();
 ...
 ResultSet rs= cousys.concourier.getData("select * from dbcust where cid="+no1+"");
